    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 py-12">
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8 space-y-6 text-center">
          ...
          <Link href="/shoplist">
          <button className="bg-[#FB2E86] text-white px-6 py-2 rounded-md text-lg font-medium hover:bg-pink-600">
            Continue Shopping
          </button>
          </Link>
          <Link href="">
          <button className="bg-[#3c2efb] text-white px-6 py-2 rounded-md text-lg font-medium hover:bg-violet-600">
            View Order Summary
          </button>
          </Link>
          </div>
